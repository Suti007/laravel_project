...
<body class="antialiased">
    ...
    <div class="container mx-auto">
        <div class="hero-section bg-cover-bg-center h-screen flex items-center justify-center text-white"
            ...
            <div class="bg-red bg-opacity-50 p-8 rounded text-center text-gray-700">
                <h1 class="text-5xl font-bold mb-4 text-gray-700">Welcome to our E commerce store</h1>
                ...
                <a class="bg-blue-500 hover: bg-blue-700 text-white font-bold py-2 px-4 roounded"
                    href={{route('product.welcome')}}>Show Now</a>
